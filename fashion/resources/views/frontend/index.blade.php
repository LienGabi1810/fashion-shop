				...
				<div class="block2">
					...
					<div class="block2-txt flex-w flex-t p-t-14">
						<div class="block2-txt-child1 flex-col-l ">
							<a href="/product/detail/{{$newProduct->id}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								{{ $newProduct->name }}
							</a>
		...
		<div class="row isotope-grid">
			...
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
				...
				<div class="block2">
					...
					<div class="block2-txt flex-w flex-t p-t-14">
						<div class="block2-txt-child1 flex-col-l ">
							<a href="/product/detail/{{$hotProduct->id}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								{{$hotProduct->name}}
							</a>

							<span class="stext-105 cl3">
								{{number_format($hotProduct->price, 0,'', ',')}} VND
							</span>
						</div>
